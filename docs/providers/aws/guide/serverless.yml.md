...
enableLocalInstallationFallback: false # If set to 'true', guarantees that it's framework installed locally for service (in its node_modules) which processes the command
