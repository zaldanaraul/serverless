      ...
      if (functionObj.events) {
        ...
        functionObj.events.forEach(event => {
          if (event.sqs) {
            ...
            const sqsStatement = _.cloneDeep(sqsStatementTemplate);
            ...
            // add policy statements to function's iamConfig object
            functionObj.iamConfig.policyStatements.push(sqsStatement);
          }
        });
      }
    });
