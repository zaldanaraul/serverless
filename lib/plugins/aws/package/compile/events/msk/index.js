    ...
    this.serverless.service.getAllFunctions().forEach(functionName => {
      ...
      functionObj.events.forEach(event => {
        if (event.msk) {
          ...
          // push IAM role statements unto function's iamConfig object
          functionObj.iamConfig.policyStatements.push(mskStatement);
          functionObj.iamConfig.policyStatements.push(ec2Statement);
        }
      });
    });
  }
